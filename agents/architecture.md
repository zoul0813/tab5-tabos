...
Tab5 I2C keyboard are backend producers. The SDL host derives CP437 text from normalized
physical key events and leaves native Unicode IME composition disabled. Future USB HID support
