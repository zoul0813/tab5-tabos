...
int main(void)
{
    ...
    platform_framebuffer_t framebuffer = {
        .pixels = pixels, .width = 4U, .height = 4U, .stride_pixels = 4U,
    };
    ...
    const tabos_graphics_blit_options_t rotated = {
        .pixels = source, .bitmap_width = 2U, .bitmap_height = 2U,
    ...
    const tabos_graphics_blit_options_t keyed = {
        ...
        .opacity = 255U, .color_key_enabled = true,
        .color_key_low = 2U, .color_key_high = 2U,
    };
    for (size_t index = 0U; index < 16U; ++index) pixels[index] = 9U;
    ...
    const tabos_graphics_blit_options_t blended = {
        .pixels = &white, .bitmap_width = 1U, .bitmap_height = 1U,
        .source = {.width = 1U, .height = 1U},
        .destination = {.width = 1U, .height = 1U}, .opacity = 128U,
    };
    pixels[0] = 0U;
