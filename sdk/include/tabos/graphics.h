...
#define TABOS_RGB565(red, green, blue)                                                            \
    ((tabos_color_t) ((((uint16_t) (red) & 0xf8U) << 8U) | (((uint16_t) (green) & 0xfcU) << 3U) | \
                      ((uint16_t) (blue) >> 3U)))
...
int tabos_graphics_line(tabos_graphics_t* graphics, int32_t x0, int32_t y0, int32_t x1, int32_t y1,
                        tabos_color_t color);
