...
partial-init unwind, network-state synchronization, immediate RTC/battery health
notifications, headless audio progress and recoverable FAT replacement. Historical
